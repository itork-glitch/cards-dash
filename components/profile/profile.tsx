    ...
    <div>
      <div className='relative bg-slate-50'>
        <Image
          ...
          width={300}
          height={300}
          className='rounded-full border-[7px] border-slate-100 absolute top-[-10vh] right-[70vw] left-[5vw]'
        />
        <h1 className='ml-[28vw] font-bold text-6xl py-6'>
          {session?.user?.name}
        </h1>
        <p className='ml-[28vw] text-slate-600 flex items-center gap-1 pb-4'>
          <MdAlternateEmail />
          {session?.user?.email}
        </p>
      </div>
